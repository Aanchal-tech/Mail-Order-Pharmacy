...
public class DrugServiceApplication {
	...
	CommandLineRunner init(DrugDetailsRepo drugDetailsRepository,DrugLocationRepo drugLocationRepo)	 {
	    ...
	    return args -> {
	       ...
	       DrugDetails newDrugDetails3 = DrugDetails.builder().drugId("D4").drugName("Dolo 650").manufactureDate(LocalDate.parse("2022-05-05")).expiryDate(LocalDate.parse("2024-05-05")).manufacturer("Aanchal").build();
